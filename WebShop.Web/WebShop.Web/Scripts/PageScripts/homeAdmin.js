                    ...
                    $.each(response,
                        function (i, item) {
                            trHtml += '<tr><td><img src="' +
                                ...
                                '</td><td>' +
                                home.getEditButton(item.ART_Id) +
                                '</td><td>' +
                                home.getDeleteButton(item.ART_Id) +
                                '</td></tr>';
                        });
...
home.getEditButton = function (articleId) {
    return '<a class="btn btn-sm btn-primary" data-id="' + articleId + '" data-action="Edit">Modifier</a>';
};
home.getDeleteButton = function (articleId) {
    return '<a class="btn btn-sm btn-danger" data-id="' + articleId + '" data-action="Delete">Supprimer</a>';
};
